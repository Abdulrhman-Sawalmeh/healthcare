...
export const navigationItems: NavigationItem[] = [
  ...
  { to: "/patients", label: "المرضى", roles: ["CENTRAL_ADMIN", "CENTER_MANAGER", "DOCTOR", "RECEPTIONIST", "NURSE"] },
  { to: "/visits", label: "الزيارات", roles: ["CENTER_MANAGER", "DOCTOR", "RECEPTIONIST", "NURSE"] },
  { to: "/referrals", label: "الإحالات", roles: ["CENTRAL_ADMIN", "CENTER_MANAGER", "DOCTOR", "RECEPTIONIST", "NURSE"] },
