...
export const navigationItems: NavigationItem[] = [
  { to: "/ai-assistant", label: "المساعد الذكي", roles: ["PATIENT", ...allCenterRoles.filter((role) => role !== "PHARMACIST")] },
  ...
  { to: "/visit-workflow", label: "ملفات الزيارة والمتابعة", roles: allCenterRoles.filter((role) => !["LAB_TECH", "PHARMACIST"].includes(role)) },
  { to: "/lab", label: "طلبات المختبر", roles: ["LAB_TECH"] },
  { to: "/pharmacy/prescriptions", label: "الوصفات الواردة", roles: ["PHARMACIST"] },
  { to: "/pharmacy/dispensing", label: "صرف الأدوية", roles: ["PHARMACIST"] },
  { to: "/pharmacy/inventory", label: "مخزون الأدوية", roles: ["PHARMACIST"] },
  ...
  { to: "/pharmacy/notifications", label: "إشعارات الصيدلية", roles: ["PHARMACIST"] },
  { to: "/pharmacy/audit", label: "سجل الصرف والتدقيق", roles: ["PHARMACIST"] },
  { to: "/master-data", label: "البيانات المرجعية", roles: ["CENTRAL_ADMIN"] },
  { to: "/reports", label: "التقارير", roles: ["CENTRAL_ADMIN"] },
  { to: "/notifications", label: "الإشعارات", roles: ["PATIENT", "CENTRAL_ADMIN", ...allCenterRoles.filter((role) => role !== "PHARMACIST")] }
];
