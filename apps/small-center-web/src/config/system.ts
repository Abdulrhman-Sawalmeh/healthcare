...
export const systemConfig: FrontendSystemConfig = {
  ...
  allowedRoutes: ["/", "/appointments", "/medical-record", "/doctors", "/messages", "/ai-assistant", "/patients", "/visits", "/visit-workflow", "/referrals", "/prescription-verification", "/notifications"],
