...
const SENSITIVE_ASSIGNMENT_PATTERN =
  /\b(DATABASE_URL|JWT_SECRET|SMTP_PASS|SMTP_USER|EMAIL_API_KEY|API[_-]?KEY|BREVO_API_KEY|SENDINBLUE_API_KEY|GEMINI_API_KEY|OPENROUTER_API_KEY|GOOGLE_GENERATIVE_AI_API_KEY|GOOGLE_API_KEY|TOKEN|AUTHORIZATION|PASSWORD|RESET_CODE)\b\s*[:=]\s*["']?[^"',;\s]+/gi;
