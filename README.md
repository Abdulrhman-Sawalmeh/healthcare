...
ثلاثة أنظمة مستقلة مترابطة:

- `النظام المركزي`
- `المركز الصحي المتوسط`
- `المركز الصحي الصغير`

كل نظام مستقل بواجهة ويب مستقلة وواجهة برمجة مستقلة، مع بقاء التكامل بين الأنظمة مبنيا على نموذج الإشعارات والإحالات والسجل الموحد للمرضى.
...
- إحالات ذكية بين المراكز بناء على التخصص والتوافر والضغط التشغيلي
